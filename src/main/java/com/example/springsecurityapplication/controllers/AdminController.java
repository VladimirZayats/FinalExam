...
//        PersonDetails personDetails = (PersonDetails) authentication.getPrincipal();
    ...
    @GetMapping("admin/adminOrders/edit/{id}")
    ...
    @PostMapping("admin/adminOrders/edit/{id}")
    public String editOrder(@ModelAttribute("orders") @Valid Order order, @PathVariable("id") int id, Status status){
//        if(bindingResult.hasErrors()){
//            model.addAttribute("category", categoryRepository.findAll());
//            return "product/editProduct";
//        }

        orderService.updateOrder(id, order, status);
        return "redirect:/admin";
    }
}
